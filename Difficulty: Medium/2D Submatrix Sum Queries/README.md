<h2><a href="https://www.geeksforgeeks.org/problems/2d-submatrix-sum-queries/1?_gl=1*1swhdb4*_up*MQ..&gclid=CjwKCAiA3fnJBhAgEiwAyqmY5btNBBaqppn1t3sfod9UT_wgKaMN7BUQGkH9VrUOpFCOunhkgSU1fBoC9RcQAvD_BwE&gbraid=0AAAAAC9yBkAuS_VOgDKRnRymw06WRwqDb">2D Submatrix Sum Queries</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a 2D integer matrix <strong>mat[][]</strong> and a list of queries <strong>queries[][]</strong>, your task is to answer a series of <strong>submatrix sum</strong> <strong>queries</strong>.</span></p>
